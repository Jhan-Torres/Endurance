<template>
  ...
  <footer 
    class="flex flex-col items-center bg-black text-center text-white p-1 select-none" 
  >
    <div class="container">
        ...
        >
          ...
          >
            <path
              ...
              3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 
