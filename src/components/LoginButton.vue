<template>
  <div
    @click="handleSession"
    class="font-body text-center group relative inline-block overflow-hidden rounded border-4 bg-gray-300 
    px-6 py-1 font-bold text-slate-800 focus:outline-none focus:ring active:text-white cursor-pointer"
  ...
  >
    <span 
      ...
      :class="{
        'border-violet-600' : buttonText === 'LogIn', 
        'border-red-500' : buttonText === 'LogOut'
      }"
    />
    <span 
